...
# Regression specs for all countries (USDT instead of BTC/ETH/LTC)
regression_specs = {
    "US Regression": {
...
with open("USDT_regressions.tex", "w") as f_out:
    for sheet, spec in regression_specs.items():
        ...
        lines.append(f"\\caption{{Tether {sheet}}}")
...
print("All USDT regressions completed. Results saved to USDT_regressions.tex")
