...
# Regression specs for all countries (ETH instead of BTC)
regression_specs = {
    "US Regression": {
...
with open("ETH_regressions.tex", "w") as f_out:
    for sheet, spec in regression_specs.items():
        ...
        lines.append(f"\\caption{{Ethereum {sheet}}}")
...
print("All ETH regressions completed. Results saved to ETH_regressions.tex")
