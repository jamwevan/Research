...
# Regression specs for all countries (LTC instead of BTC/ETH)
regression_specs = {
    "US Regression": {
...
with open("LTC_regressions.tex", "w") as f_out:
    for sheet, spec in regression_specs.items():
        ...
        lines.append(f"\\caption{{Litecoin {sheet}}}")
...
print("All LTC regressions completed. Results saved to LTC_regressions.tex")
