...
# Regression specs for all countries (DOGE instead of BTC/ETH/LTC/USDT/XRP)
regression_specs = {
    "US Regression": {
        "dependent": "SPXT Index (Natural Log Changes)",
        "independents": [
            "DOGE_USD (Natural Log Changes)",
            "BCOM Index (Changes)",
...
label_map = {
    "DOGE_USD (Natural Log Changes)": r"$\Delta \log(\mathrm{DOGE}_{USD})$",
    "DOGE_GBP (Natural Log Changes)": r"$\Delta \log(\mathrm{DOGE}_{GBP})$",
    "DOGE_EUR (Natural Log Changes)": r"$\Delta \log(\mathrm{DOGE}_{EUR})$",
    "DOGE_JPY (Natural Log Changes)": r"$\Delta \log(\mathrm{DOGE}_{JPY})$",
    "DOGE_CNY (Natural Log Changes)": r"$\Delta \log(\mathrm{DOGE}_{CNY})$",
    "DOGE_BRL (Natural Log Changes)": r"$\Delta \log(\mathrm{DOGE}_{BRL})$",
    "DOGE_INR (Natural Log Changes)": r"$\Delta \log(\mathrm{DOGE}_{INR})$",
    "DOGE_ZAR (Natural Log Changes)": r"$\Delta \log(\mathrm{DOGE}_{ZAR})$",
...
with open("DOGE_regressions.tex", "w") as f_out:
    for sheet, spec in regression_specs.items():
        ...
        lines.append(f"\\caption{{Dogecoin {sheet}}}")
...
print("All DOGE regressions completed. Results saved to DOGE_regressions.tex")
