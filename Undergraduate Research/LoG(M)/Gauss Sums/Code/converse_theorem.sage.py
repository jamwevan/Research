...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_100 = Integer(100)# This file was *autogenerated* from the file converse_theorem_info.sage
